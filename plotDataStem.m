function [] = plotDataStem (Name,pop,cases,deaths,recovered)
%--------------------------------------------------------------------------
% plotData.m
% 
...
p1 = semilogy(cases./pop,'k-','DisplayName',[Name ' Confirmed Cases'],'MarkerSize',8,'LineWidth',2);
p2 = semilogy(length(cases),cases(end)./pop,'o','DisplayName',[Name ' Confirmed Cases'],'MarkerSize',8,'LineWidth',2);
hold on
%p2 = semilogy(deaths./pop,'k-','DisplayName',[Name ' Confirmed Deaths'],'MarkerSize',8);
%p3 = semilogy(recovered./pop,'k-','DisplayName',[Name ' Confirmed Recovery'],'MarkerSize',10);
% ffig = gcf;
