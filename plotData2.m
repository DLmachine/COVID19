function [] = plotData2(Name,cases,deaths,recovered)
%--------------------------------------------------------------------------
% plotData.m
% 
...
text(length(cases)+3,cases(end),['Cases: ' num2str(cases(end))])
text(length(deaths)+3,deaths(end),['Deaths: ' num2str(deaths(end))])
